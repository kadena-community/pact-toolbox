...
//   connect(publicKey: Address): void;
//   disconnect(): void;
...
//   quickSign(message: Uint8Array, connection: Connection, options?: SendOptions): Promise<TransactionSignature>;
// }
...
//   abstract publicKey: Address | null;
