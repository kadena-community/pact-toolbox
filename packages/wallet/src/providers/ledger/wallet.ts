...
// import { Pact, createSignWithKeypair, isSignedTransaction, readKeyset } from '@kadena/client';
// import { PactNumber } from '@kadena/pactjs';
// import type { BuildTransactionResult, TransferCrossChainTxParams, TransferTxParams } from '@ledgerhq/hw-app-kda';
...
//     return {
//       publicKey: hexToBuffer(env('QA_LEDGER_MOCKED_PUBKEY', 'ENV VAR NOT SET!')),
//       address: null,
//     };
//   }
...
//   async signTxInternal(params: TransferCrossChainTxParams, txType: 0 | 1 | 2): Promise<BuildTransactionResult> {
...
//         .execution(Pact.modules.coin['transfer-create'](sender, params.recipient, readKeyset('account-guard'), amount))
//         .addKeyset('account-guard', 'keys-all', stripAccountPrefix(params.recipient))
//         .addSigner(senderKey, (signFor) => [signFor('coin.TRANSFER', sender, params.recipient, amount)])
...
//           signFor('coin.TRANSFER_XCHAIN', sender, params.recipient, amount, `${params.recipient_chainId}`),
//         ])
//         .addSigner(senderKey, (signFor) => [signFor('coin.GAS')])
//         .setMeta({
//           senderAccount: sender,
...
// export const getKadenaLedgerApp = async (): Promise<AppKda | IKadenaLedgerAppLike> => {
