  ...
  describe("updatedNestedDataByPath", () => {
    ...
    describe("object", () => {
      it("should update data correctly", async () => {
        ...
        const newData = updateNestedDataByPath(oldData, ["title"], "Brave new world");
    ...
    describe("nested data", () => {
      it("should update data correctly", async () => {
        ...
        const oldData = new Map([
          ...
          [
            "spaghetti-bolonese",
            {
              ...
              ingredients: new Set(["spaghetti", "tomato sauce", "minced meat"]),
              steps: ["cook", "eat"],
              translations: new Map([
        ...
        const updatedArray = updateNestedDataByPath(oldData, ["spaghetti-bolonese", "steps", "0"], "prepare");

        const updatedSet = updateNestedDataByPath(oldData, ["pumpkin-pie", "ingredients", "1"], "honey");

        const updatedMap = updateNestedDataByPath(oldData, ["pumpkin-pie", "translations", "en"], "Best pie ever");
  ...
  describe("deleteNestedDataByPath", () => {
    ...
    describe("nested data", () => {
      it("should delete nested items correctly", async () => {
        ...
        const deletedFromSet = deleteNestedDataByPath(oldData, ["spaghetti-bolonese", "ingredients", "0"]);

        const deletedFromArray = deleteNestedDataByPath(oldData, ["pumpkin-pie", "steps", "1"]);

        const deletedFromObject = deleteNestedDataByPath(oldData, ["pumpkin-pie", "title"]);

        const deletedFromMap = deleteNestedDataByPath(oldData, ["spaghetti-bolonese", "translations", "fr"]);
