import type { KeyPair, Wallet } from "@pact-toolbox/types";
...
export function isWallet(signer: unknown): signer is Wallet {
  if (typeof signer === "object" && signer !== null && "getAccount" in signer && "sign" in signer) {
    return true;
  }
  return false;
}
