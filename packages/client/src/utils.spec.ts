...
describe("KDA Client Helpers", () => {
  ...
  describe("generateKAccount", () => {
    it("should generate a valid K-account", () => {
      const account = generateKAccount();
  ...
  describe("generateKAccounts", () => {
    it("should generate the specified number of K-accounts", () => {
      const count = 5;
      const accounts = generateKAccounts(count);
    ...
    it("should default to 10 accounts if no count is provided", () => {
      const accounts = generateKAccounts();
