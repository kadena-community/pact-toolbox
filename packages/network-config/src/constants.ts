import type { KeyPair, PactKeyset } from "@pact-toolbox/types";
 ...
 */
export const DEFAULT_KEY_PAIRS: KeyPair[] = [
  {
    account: "sender00",
 ...
 * @internal
 */
export const DEFAULT_KEY_PAIRS_OBJECT: Record<string, KeyPair> = DEFAULT_KEY_PAIRS.reduce(
  (acc, keyPair) => ({
    ...acc,
 ...
 */
export const DEFAULT_KEYSETS: Record<string, PactKeyset> = DEFAULT_KEY_PAIRS.reduce(
  (acc, signer) => ({
    ...acc,
    [signer.account]: {
