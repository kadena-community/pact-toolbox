...
export type FixedSizeCodec<TFrom, TTo = TFrom, TSize extends number = number> = FixedSizeDecoder<TTo, TSize> &
  FixedSizeEncoder<TFrom, TSize>;

export type VariableSizeCodec<TFrom, TTo = TFrom> = VariableSizeDecoder<TTo> & VariableSizeEncoder<TFrom>;
 ...
 */
export type Codec<TFrom, TTo = TFrom> = FixedSizeCodec<TFrom, TTo> | VariableSizeCodec<TFrom, TTo>;
 ...
 */
export function combineCodec<TFrom, TTo, TSize extends number>(
  encoder: FixedSizeEncoder<TFrom, TSize>,
  decoder: FixedSizeDecoder<TTo, TSize>,
): FixedSizeCodec<TFrom, TTo, TSize>;
export function combineCodec<TFrom, TTo>(
  encoder: VariableSizeEncoder<TFrom>,
  decoder: VariableSizeDecoder<TTo>,
): VariableSizeCodec<TFrom, TTo>;
export function combineCodec<TFrom, TTo>(encoder: Encoder<TFrom>, decoder: Decoder<TTo>): Codec<TFrom, TTo>;
export function combineCodec<TFrom, TTo>(encoder: Encoder<TFrom>, decoder: Decoder<TTo>): Codec<TFrom, TTo> {
 ...
 */
export function fixCodecSize<TFrom, TTo, TSize extends number>(
  codec: Codec<TFrom, TTo>,
  fixedBytes: TSize,
): FixedSizeCodec<TFrom, TTo, TSize> {
