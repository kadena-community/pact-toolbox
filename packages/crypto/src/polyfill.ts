 ...
 * the methods that interact with it are not exported from `webcrypto-ed25519-polyfill`,
...
import { __BROWSER__, __DEV__, __NODEJS__ } from "./constants";
...
export function installEd25519Polyfill(): void {
  if (__NODEJS__) {
    /**
