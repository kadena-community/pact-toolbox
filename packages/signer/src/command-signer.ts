...
import { base16, base64Url, blake2b, getAddressFromPublicKey, signBytes, utf8 } from "@pact-toolbox/crypto";
...
export async function partiallySignPactCommand(
  ...
  for (const keyPair of keyPairs) {
    const pubKeyHex = await getAddressFromPublicKey(keyPair.publicKey);
